...
| **Warning** | Allowable with disclosure (Cloud `content-marker-verified`, page count > 5, `review-required` assets, unconfirmed facts marked in copy) | May deliver if listed |
