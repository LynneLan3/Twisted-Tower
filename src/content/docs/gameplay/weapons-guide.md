...
cover: ../../../assets/screenshots/combat-arena.jpg
changeSummary: Initial release.
eyebrow: Arsenal
facts:
  -
    label: Starting weapon
    value: Twisted Mallet
  -
    label: Upgrade currency
    value: Tickets
  -
    label: Weapon theme
    value: Toys / Carnival
  -
    ...
    value: "Unlockable (Alt Fire Fiend)"
---
<!--
...
![Twisted Tower combat encounter in an amber-lit arena — official Steam screenshot](../../../assets/screenshots/combat-arena.jpg)
