...
cover: ../../../assets/screenshots/hero-carnival.jpg
...
facts:
  ...
  -
    label: Themes
    value: Hotel / Waterpark / Clown Casino / Carnival Forest / Space Station
  -
    label: Route
    value: Varies per playthrough
  -
    label: Summit
    value: Top of the tower
---
<!--
...
![Twisted Tower hotel floor interior with warm lighting — official Steam screenshot](../../../assets/screenshots/floor-hotel.jpg)
...
![Twisted Tower Clown Casino floor glowing with golden lights — official Steam screenshot](../../../assets/screenshots/floor-clown-casino.jpg)

4. **Carnival Forest** — an outdoor forest/carnival area featuring ride-based combat such as ferris wheels.

![Twisted Tower Carnival Forest floor with dark green foliage — official Steam screenshot](../../../assets/screenshots/floor-carnival-forest.jpg)

5. **Space Station** — a retro-futuristic space station near the top of the tower, staging the finale.

![Twisted Tower Space Station floor with neon purple lighting — official Steam screenshot](../../../assets/screenshots/floor-space-station.jpg)
