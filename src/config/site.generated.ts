...
export const siteConfig: GameConfig = {
	...
	portal: {
		...
		primaryCta: {
			...
			href: "/twisted-tower/beginner-guide/",
		},
		secondaryCta: {
		...
		popularQuestions: [
			{
				...
				href: "/twisted-tower/release-info/",
			},
			{
			...
			},
			{
				...
				href: "/twisted-tower/system-requirements/",
			},
			{
		...
		startHere: [
			...
			},
			{
				...
				href: "/twisted-tower/weapons-guide/",
			...
			},
			{
				...
				href: "/twisted-tower/five-floors/",
			...
			},
			{
				...
				href: "/twisted-tower/achievements-guide/",
				label: "Achievements",
			},
		],
		evidence: {
	...
	routes: [
		{
			...
			href: "/twisted-tower/routes/first-time-players/",
		...
		},
		{
			...
			href: "/twisted-tower/routes/reaching-the-top/",
			...
			pages: [
				...
				{
					pageId: "movement-toys",
					href: "/twisted-tower/movement-toys/",
					title: "Movement Toys",
				...
				{
					pageId: "adventure-plus",
					href: "/twisted-tower/adventure-plus/",
	...
	trust: {
		...
		pages: {
			...
			editorialMethod: {
				...
				path: "/twisted-tower/editorial-method/",
